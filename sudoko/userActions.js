...
function initActions() {
  ...
  // to handle the action after click of SUBMIT btn
  ...
  // func to handle the click on the dot menu icon
  function dotMenuHandler(e) {
    ...
    if (isFirstTime_dotMenu) {
      ...
      speedRangeButton.addEventListener("click", (event) =>
        speedRangeHandler(event)
      );
